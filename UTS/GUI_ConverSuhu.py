...
label_suhu = tk.Label(root, text="Masukkan Nilai Suhu:")
...
# Tombol konversi dengan gambar
image_path = 'C:/Users/nazar/PBO/UTS/Media/convertbutton.png'
konversi_image = PhotoImage(file=image_path)
tombol_konversi = tk.Button(root, image=konversi_image, command=konversi_suhu)
